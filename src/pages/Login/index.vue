<template>
  <div class="login-container">
    ...
    <div class="login-wrap">
      <div class="login">
        <div class="title">
          <p class="gt-title">缘来O'Mall<br />GIVE YOU MORE</p>
        </div>
        <div class="loginform">
...
.login-container {
  .login-wrap {
    ...
    .login {
      ...
      height: 487px;
      margin: 0 auto;
      background: url(https://img.51msyc.com/wxapp/pc/image/images/omall_top.png?x-oss-process=image/resize,w_2560) no-repeat;
    }
    .title {
      position: absolute;
      width: 600px;
