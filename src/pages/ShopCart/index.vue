  ...
  <div class="cart">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con5">
            ...
            <input autocomplete="off" :value="cart.skuNum" type="text" @change="handler('change', $event.target.value * 1, cart)" minnum="1" class="itxt" />
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isCartChecked && cartInfoList.length > 0" @click="updateAllChecked" />
        <span>全选</span>
      </div>
      <div class="option">
